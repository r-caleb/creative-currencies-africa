...
test("keeps the member dashboard preview coherent", async () => {
  ...
  assert.match(dashboard, /getDashboardRoleConfig\(user\?\.type\)/);
  assert.match(dashboard, /creatorDashboardConfig/);
  assert.match(dashboard, /learnerDashboardConfig/);
  assert.match(dashboard, /publicDashboardConfig/);
  assert.match(dashboard, /structureDashboardConfig/);
  assert.match(dashboard, /adminDashboardConfig/);
  assert.match(dashboard, /Vos priorités créateur/);
  assert.match(dashboard, /Vos priorités apprenant/);
  assert.match(dashboard, /Vos prochaines étapes/);
  assert.match(dashboard, /Vos priorités structure/);
  assert.match(dashboard, /accountType === "ORGANIZATION" \|\| accountType === "PARTNER"/);
  assert.match(dashboard, /Priorités administrateur/);
  ...
  assert.match(dashboard, /dashboardConfig\.insightTitle/);
  ...
  assert.match(creativeId, /Portfolio structuré/);
  assert.match(creativeId, /Historique officiel/);
